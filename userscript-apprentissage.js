...
// @version      1.8
// @description  Apprend chaque page de galerie Singles dès son chargement, suit les 1 670 produits CIBLES (jamais appris, slug vide), et tient un JOURNAL par page (📥 pour l'exporter). Lit UNIQUEMENT la page ouverte — ne navigue jamais.
...
(function () {
  ...
  const PRODUITS_EXPORT = {"1521":151,"1525":66,"1535":117,"1539":118,"1546":113,"1548":147,"1551":112,"1555":145,"1566":150,"1567":113,"1569":111,"1578":144,"1579":131,"1582":168,"1583":127,"1585":177,"1605":25,"1612":273,"1634":18,"1649":129,"1660":133,"1678":216,"1687":174,"1693":143,"1706":162,"1716":143,"1742":132,"1745":228,"1757":316,"1800":242,"1824":222,"1842":91,"1843":150,"2065":215,"2070":61,"2075":184,"2107":94,"2320":219,"2351":93,"2352":12,"2370":275,"2407":219,"2437":266,"2487":293,"2514":186,"2644":285,"2916":386,"2921":249,"3143":234,"3199":227,"3214":354,"3274":119,"3324":422,"3419":102,"3580":330,"3675":206,"3816":115,"3946":70,"3961":73,"4079":27,"4084":20,"4119":20,"4129":25,"4154":51,"4159":411,"4170":208,"4174":255,"4179":34,"4181":19,"4187":72,"4188":18,"4189":20,"4190":20,"4192":19,"4196":48,"4197":18,"4198":18,"4199":18,"4205":32,"4206":20,"4207":20,"4211":26,"4214":58,"4216":57,"4238":32,"4240":8,"4241":21,"4242":24,"4243":78,"4252":41,"4291":15,"4328":260,"4340":20,"4347":69,"4348":19,"4382":303,"4390":293,"4392":19,"4434":245,"4490":48,"4516":22,"4517":21,"4518":25,"4786":102,"4979":271,"5051":109,"5093":266,"5142":266,"5201":256,"5212":304,"5216":116,"5223":316,"5241":304,"5318":337,"5328":210,"5385":271,"5402":242,"5431":201,"5444":314,"5519":360,"5526":48,"5546":270,"5589":263,"5621":98,"5681":25,"5682":22,"5683":19,"5684":22,"5685":19,"5686":20,"5691":268,"5757":94,"5760":109,"5796":36,"5834":85,"5861":9,"5877":55,"5879":281,"5890":140,"5996":132,"6006":190,"6009":243,"6092":132,"6096":244,"6127":302,"6130":174,"6131":174,"6134":172,"6135":173,"6209":188,"6219":306,"6230":144,"6237":164,"6290":35,"6291":116,"6299":130,"6309":101,"6328":358,"6381":774,"6391":199,"6392":86,"6393":131,"6395":295,"6409":236,"6427":117,"6442":97,"6443":124,"6494":120,"6509":48,"6510":48,"6517":122,"6549":315,"6556":118,"6569":120,"6581":336,"6602":176,"6603":176,"6604":203,"6634":141,"6672":146,"6673":380,"6683":2,"6699":266,"6700":122};
  ...
  function lireCartesDeLaPage() {
    ...
    document.querySelectorAll('a.galleryBox').forEach(a => {
      ...
      if (!r || !r.id) {
        ...
        ECARTEES.push({ href: String(a.getAttribute('href') || '').slice(0, 160), titre: h2e ? h2e.textContent.trim().slice(0, 80) : null,
  ...
  function exporterJournal() {
    const donnees = { script: '1.8', exporteLe: new Date().toISOString(), userId: ID_UTILISATEUR, journal: lire('rm_journal', []),
  ...
  function noterSucces(items, c) {
    ...
    annoterJournal(items.map(i => i.cle), { status: 200, le: Date.now(), pagesGroupees: items.length, recus: c.recus ?? null, nouvelles: c.nouvelles ?? 0, ameliorees: c.ameliorees ?? 0,
      dejaExactes: c.dejaExactes ?? 0, completees: c.completees ?? 0, sansNumero: c.sansNumero ?? 0, ignorees: c.ignorees ?? null, idExpansions: c.idExpansions ?? null, couverture: c.couverture ?? null });
  ...
  journaliser({ le: Date.now(), v: '1.8', url: ctx.cle, exp: idCourant(), slugSet: ctx.slugSet, page: ctx.page, pages: ctx.pages, suivante: !!ctx.hrefSuivant,
    ...
    filtres: DIAG.filtres, params: DIAG.params, ids: cartesPage.map(c => c.idProduct), cibles: cartesPage.filter(c => CIBLE.has(c.idProduct)).map(c => c.idProduct),
  ...
  function majPanneau() {
    ...
    h += `<div style="font-size:11px;margin-bottom:6px;color:#aaa">🔎 ${DIAG.vignettes} vignette(s) · ${cartesPage.length} lue(s)` +
      (ECARTEES.length ? ` · <b style="color:#f56c6c">${ECARTEES.length} écartée(s) : image illisible (voir le journal)</b>` : '') +
