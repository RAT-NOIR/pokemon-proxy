...
//      35 pour l'attaque. Première mise en mémoire : appliquée DANS le bloc du périmètre, sur
//      le vivier déjà restreint aux 24 sets japonais vintage, avec la règle « un seul
//      survivant = verdict FERME ». Rejeu du banc : 12 désignations, 10 justes fermes, et
//      DEUX FAUX AFFIRMÉS — Ho-Oh, H075 et L069, vérité 654129 « Unnumbered Promos »
//      (expansion 4170, hors des 24 sets), rendu 606685 « Awakening Legends » N3.
//      LA CAUSE. Le périmètre avait déjà RETIRÉ la vérité (c'est la classe qui porte 13 des 14
//      absences du vivier de la route). V a ensuite vidé ce qui restait jusqu'à un produit, et
//      la règle a lu ce produit comme une preuve. Or un filtre ne peut que RETIRER : il ne sait
//      rien de ce qui n'est pas entré. Un survivant unique d'un vivier amputé dit « un seul
//      dans ce que j'ai laissé entrer », jamais « un seul existe ».
//      🔑 LA LEÇON. Même famille que l'entrée 25 (« une unicité obtenue par une requête
//      incomplète n'est pas une unicité »), de l'autre côté : là-bas la requête n'avait pas
//      cherché partout ; ici le vivier avait été RESTREINT avant que la clé ne compte. Une clé
//      ne désigne que sur le vivier ENTIER du nom. Toute restriction posée avant elle
//      (périmètre, expansions attendues, table close) transforme son unicité en reste — et le
//      reste, lui, AFFIRME. Le coût n'est pas une mesure faussée : c'est un prix affiché sans
//      réserve sur la mauvaise carte, exactement ce que le périmètre avait été conçu pour
//      éviter en sortant toujours « sous réserve ».
//      LA PARADE, MÉCANIQUE : une clé qui autorise un verdict FERME s'applique AVANT toute
