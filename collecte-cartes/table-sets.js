...
const TABLE = [
    ...
    { code: 'xWHT', exp: 6198, prod: 157, nom: 'White Flare Additionals', slugSet: 'White-Flare-Additionals', region: 'occidental', bulba: { titre: 'Black Bolt & White Flare (TCG)', tirage: 'intl', expansion: 'Black Bolt & White Flare' }, attendu: 157, additionalsDe: 'WHT' },
    { code: 'xBLK', exp: 6197, prod: 156, nom: 'Black Bolt Additionals', slugSet: 'Black-Bolt-Additionals', region: 'occidental', bulba: { titre: 'Black Bolt & White Flare (TCG)', tirage: 'intl', expansion: 'Black Bolt & White Flare' }, attendu: 156, additionalsDe: 'BLK' },
